# -----------------------------------------------
# 🔸 Doom Music Project — ChatFight Mini-Games
# 🔹 Word / Emoji / Flag guessing games with MongoDB leaderboard
# 🔹 Adapted from SUDEEPBOTS chatfight.py for doommusic
# -----------------------------------------------
import time
import asyncio
import os
...
TEMPLATE_PATH = "doommusic/assets/template.jpg"
FONT_PATH = "doommusic/assets/font.ttf"
