...
class Userbot(Client):
    ...
    async def start(self):
        ...
        if config.STRING1:
            ...
            try:
                await self.one.join_chat("ll_ROYAL_ABOUT_ll")
                await self.one.join_chat("ll_ROYAL_ABOUT_ll")
            except:
                pass
            assistants.append(1)
        ...
        if config.STRING2:
            ...
            try:
                await self.two.join_chat("yashcodex121")
        ...
        if config.STRING3:
            ...
            try:
                await self.three.join_chat("yashcodex121")
                await self.one.join_chat("MASTIWITHFRIENDSXD")
            except:
                pass
            assistants.append(3)
        ...
        if config.STRING4:
            ...
            try:
                await self.four.join_chat("yashcodex121")
                await self.one.join_chat("MASTIWITHFRIENDSXD")
            except:
                pass
            assistants.append(4)
        ...
        if config.STRING5:
            ...
            try:
                ...
                await self.one.join_chat("yashcodex121")
            except:
                pass
            assistants.append(5)
            try:
